...
**Two repos (maintainers):** shareable code here; private backup in **MPE-Personal** as sibling `assets/`. Setup: **[docs/STABLE-SETUP.md](docs/STABLE-SETUP.md)** · paths: **[docs/PATHS.md](docs/PATHS.md)**
